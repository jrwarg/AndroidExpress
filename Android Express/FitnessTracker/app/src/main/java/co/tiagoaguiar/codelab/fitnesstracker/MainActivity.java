...
public class MainActivity extends AppCompatActivity {
    ...
    */
        ...
        mainItems.add(new MainItem( 3, R.drawable.ic_baseline_wb_sunny_24, R.string.label_imc, Color.YELLOW));
        ...
        adapter.setListener(id -> {
            ...
            case 2:
                ...
                case 3:
                    startActivity(new Intent(MainActivity.this, OthActivity.class));
            }
